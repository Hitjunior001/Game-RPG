...
if __name__ == "__main__":
    ...
    print('=================================================')
    print("Game Version 1.5!!")
    print("Created by Reginaldo and Andre")
    print("Features:")
    print("Fixed bugs")
    print("- A little balancing in the level up system.")
    print("- A new hero damage system has been added.")
    print("- - You will start the game with 0 damage..")
    print("- - And the only damage is your equipped item up to level 5..")
    print("- - After level 5, your damage will be 5 + item damage..")
    print("- The dungeon will be your worst nightmare")
    print("- Defined a way to exit the dungeon instead of exiting randomly")
    print("- - You need a key and find a door to escape the dungeon.")
    print("- Update to the way information is displayed.")
    print("- - Example, the use of the special attack.")
    print("- - You can check the item even if you don't have gold.")
    print("- Updated the terminal text color for easy visualization of the effects of your actions.")
    print("- You can only use specials if you have your main weapon equipped.")
    print('- Items can now only be equipped if they are of their type!')
    print('- - Sword')
    print('- - Archery')
    print('- - Lancer')
    print('- - All')
    print('- Balancing on item prices')
    print('- News items in blacksmith and drop')
    print('- - Claymore')
    print('- - Bone')
    print('- - Boy')
    print('- - Spear')
    print('- Donjon!! is new place')
    print('- New mobs and items')
    print('- - Scorpion')
    print('- - Scorpion Tail')
    print('- - Scorpion King')
    print('=================================================')

...
class Map():
    ...
    def Dungeon(self):
        ...
        print('=================================================')
        print("Oh, my God! You fell into a dungeon, it's too dark to be ware!!!")
        print('=================================================')
        ...
        while True:
            ...
            if option2 == '1':
                if item.equipped == False:
                    ...
                    print("You can't sell equipped item")
            else:
                break
            return False
    #USA O MESMO SISTEMA DE EQUIP_USE PORÉM DE UMA MANEIRA SIMPLIFICADA APENAS PRA EQUIPAR DE UMA VEZ E FAZER AS VERIFICAÇÕES
    ...
    def sleep(self):
        ...
        if Map.place != 'Ground':
            if self.energy < 90:
                ...
                print("You can only sleep if your energy is at least below 90")
...
class Dragontooth(Mob, Bag, Item):
    def __init__(self,name, hp = 100 ,maxHp = 100, energy = 130, maxEnergy = 130, alive = True, damage = 15, items = [],equip_chest = [], equip_weapon = [], weapon = 0, armor = 0, combat = False, golds = 0,exp=0, level=0,up_level=30):
        super().__init__(name, hp = 160,maxHp = 160, energy = 170, maxEnergy = 170,  alive = True, damage = 0, items = [], kills=0, equip_chest = [], equip_weapon = [], weapon = 0, armor = 0, golds = 0,exp=0, level=0,up_level=30, special_attack= False, style = 'sharptooth')
    #TODO HEROI TEM UM ATAQUE ESPECIAL
    def Special_Attack(self):
        if self.energy >= round(self.maxEnergy/3):
            self.special_attack = True
            ...
            print('=================================================')
            print("Special Attack!! You recite a brief prayer to invoke dragontooth warrior!!!")
            print('=================================================')
        else:
            print('=================================================')
            print("You don't have energy")
...
def Combat():
    ...
    while True: 
        if Hero.hp > 0 and mob.hp > 0:
            ...
            print("[1] Attack  🗡️")
            print(f"[2] Special Attack ⚔️  - Cost:[{bc.RED}{round(Hero.maxEnergy/3)}{bc.ENDC}{bc.BOLD}]⚡")
            print("[3] Open Bag 🎒")
            print("[4] Run 🚪")
            print('=================================================')
...
def randomWeapon():
    ...
    if Map.place == 'Ground':
        if probability >= 1 and probability <= 2:
            ...
            itemAleatory = Item('Chest', 'chest','all', 0 , 20,0,0,0,4)
            return itemAleatory
        elif probability >= 10 and probability <= 13:
...
def Blacksmith(self):
    while True:
        ...
        print("[3] - Iron Chest(1un)- [20] Golds 🟡")
        print("[4] - Balesta(1un)- [30] Golds 🟡")
        ...
        print("[12] - Sharptooth(1un)- [10] Golds 🟡")
        print("[13] - Dragon_breastplate(1un)- [10] Golds 🟡")
        print("[14] - Big_Spear(1un)- [30] Golds 🟡")
        print("[15] - Stared_Sharptooth(1un)- [30] Golds 🟡")
        print("[16] - Exit")
        option = input('Your option: ')
        if option == '1':
...
def Salesman(self):
    while True:
        print('\n\n=================================================')
        print("What do you want traveler!!?")
        print('=================================================')
        print(f"You gold's: {self.golds} 🟡")
        print("What do you want?")
        print("[1] - Potion Life(1un)- [20] Golds 🟡")
        print("[2] - Exit")
        option = input('Your option: ')
        if option == '1':
            self.buyItem(PotionSalesman)
            print("Hahahaha always come back!")
        else:
            break
...
if __name__ == "__main__":
    ...
    print("Added a new item in the main menu 'stats', for better visualization of the hero!!!")
    print("Adding a 'for' identifier to know whether or not the weapon can be used by green in an intuitive way!!!")
    print(" - New itens in blacksmith!!")
    print("- - Dragon breastplate")
    print("- - Big Spear")
    print("- - Stared Sharptooth")
    print("- - Dragon_breastplate")
    print(" - HOTFIX!!!!! -")
    print(" - Added 'for' in item attributes to see if it's compatible or not with your hero")
    print(" - Fixed bugs")
    print(" - Now you can sell items!!!")
    print(" - Now you can buy items in the dungeon or donjon with salesman!!!!!")
    print('=================================================')

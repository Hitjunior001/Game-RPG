...
# --------------------CLASS DOS MOB--------------------
class Item():
    def __init__(self, name, typer,race, damage = 0, armor = 0, life = 0, energy = 0, gold = 0 ,equipped = False):
        self.name = name
        self.typer = typer
        self.energy = energy
        self.race = race
...
class Mob(object):
    ...
    def Move(self):
        ...
        if probability >= 0 and probability <=11:
            ...
            self.pickItem(Axe)
        elif probability >= 18 and probability <=30:
            if Map.place != 'Dungeon':
                Dungeon()
            else:
                print("You left of dungeon!! congratulations")
                Map.location("Ground")
        else:
            print("You moved.")
    def level_up(self):
    ...
    def sleep(self):
        ...
        if Map.place == 'Dungeon':
            if self.energy < 80:
                ...
                print(f"recupered {random+10} energy")
                self.energy += 10
                self.energy += random
                self.verify_energy()
                hours += 3
...
def randomMob():
    ...
    if Map.place == 'Ground':
        ...
        if probability >= 1 and probability <=2:
            ...
            mob.mob_level()
            return mob
        elif probability >= 3 and probability <=7:
            mob = Enemy('Globin', 50,50,5, random_gold, random_exp)
            mob.mob_level()
            return mob
...
def randomWeapon():
    ...
    if Map.place == 'Ground':
        if probability >= 1 and probability <= 2:
            ...
            Axe = Item('Potion Life', 'potion','all', 0, 0, 100)
            return Axe
        elif probability >= 14 and probability <= 15:
            Axe = Item('Potion Energy', 'potion','all', 0, 0, 0, 100)
            return Axe
        elif probability >= 16 and probability <= 16:
            Axe = Item('Potion Full', 'potion','all', 0, 0, 0, 100)
            return Axe
        ...
        if probability >= 1 and probability <= 8:
            Axe = Item('Torch', 'test','all')
            return Axe
        elif probability >= 9 and probability <= 13:
            Axe = Item('Key', 'test','all')
            return Axe
        elif probability >= 14 and probability <= 17:
            Axe = Item('Gold_bag', 'utility','all',0,0,0,0,random_golds)
            return Axe
...
def Blacksmith(self):
    while True:
        ...
        print("[6] - Katana(1un)- [50] Golds 🟡")
        print("[7] - Dagger(1un)- [10] Golds 🟡")
        print("[8] - Potion Full(1un)- [20] Golds 🟡")
        print("[9] - Exit")
        option = input('Your option: ')
        if option == '1':
            if self.golds >= 15:
            ...
            if self.golds >= 50:
                self.buyItem(Katana, 50)
            else:
                print("You no have gold's!!")
        elif option == '8':
            if self.golds >= 10:
                self.buyItem(Dagger, 10)
            else:
                print("You no have gold's!!")
        elif option == '9':
            break
...
if __name__ == "__main__":
    ...
    print("\n\n\n")
    print('=================================================')
    print("Game Version 1.4!!")
    print("Created by Reginaldo and Andre")
    print("Features:")
    print("- Implemented a damage system according to armor")
    print("- Possibility of falling into a dungeon")
    print("- New itens in drop!!")
    print("- - Torch")
    print("- - Key")
    print("- - Gold_bag")
    print("- New mobs!!")
    ...
    print('=================================================')
    Hero = Choice_Hero()
    Potion = Item('Potion Life', 'potion','all', 0, 0, 50)
    Potion1 = Item('Potion Energy', 'potion','all', 0, 0, 0,50)
    Potion2 = Item('Potion Full', 'potion','all', 0, 0,50, 50)
    ...
    Dagger = Item('Katana', 'weapon','meele', 10, 0, 0)
        ...
        if Hero.hp > 0:  
            ...
            if option == '1':
                ...
                if Map.place == 'Ground':
                    ...
                    print("You're in the middle of the Dungeon, you can't buy anything")
            elif option == '5':
                break
            else:

...
class Monk(Mob, Bag, Item):
    def __init__(self,name, hp = 100 ,maxHp = 100, energy = 130, maxEnergy = 130, alive = True, damage = 15, items = [],equip_chest = [], equip_weapon = [], weapon = 0, armor = 0, combat = False, golds = 0,exp=0, level=0,up_level=50,special_monk = False):
        super().__init__(name, hp = 100 ,maxHp = 100, energy = 200, maxEnergy = 200, alive = True, damage = 20, items = [],equip_chest = [], equip_weapon = [], weapon = 0, armor = 0, combat = False, golds = 0,exp=0, level=0,up_level=50)
        self.special_monk = special_monk
    def Special_Attack(self):
        if self.energy >= 100:
            self.special_monk = True
            self.energy_loss(100)
            print('=================================================')
            print("Special Attack!! You have reached the advanced stage of concentration in combat!!!")
            print("Damage +30 💪")
            print("Hp +50 💗")
            print('=================================================')
            self.hp += 50
    ...
    def Disable_Special_Attack(self):
        if Hero.special_monk == True:
            self.special_monk = False
            self.damage -= 50
            if self.hp < 50:
                self.hp -= 40
                self.maxHp -=40
